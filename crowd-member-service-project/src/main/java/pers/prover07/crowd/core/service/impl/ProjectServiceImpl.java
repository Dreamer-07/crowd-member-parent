...
import pers.prover07.crowd.core.mapper.ProjectMapper;
import pers.prover07.crowd.core.service.*;
...
public class ProjectServiceImpl extends ServiceImpl<ProjectMapper, ProjectPo> implements ProjectService {
    ...
    public ProjectServiceImpl(ProjectTypeService projectTypeService, ProjectTagService projectTagService, ProjectItemPicService projectItemPicService, MemberLaunchInfoService memberLaunchInfoService, MemberConfirmInfoService memberConfirmInfoService, PayBackService payBackService) {
        this.projectTypeService = projectTypeService;
        this.projectTagService = projectTagService;
        this.projectItemPicService = projectItemPicService;
        this.memberLaunchInfoService = memberLaunchInfoService;
        this.memberConfirmInfoService = memberConfirmInfoService;
